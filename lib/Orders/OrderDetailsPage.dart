            ...
            children: [
              ...
              child: Align(
                ...
                child: Text (
                  ...
                  " dollras"  + dataMap[EcommerceApp.totalAmount].toString() ,
...
children: [
  ...
  void confirmedUserOrderRecieved(BuildContext context, String myOrderId) {


    EcommerceApp.firestore.collection(EcommerceApp.collectionUser)
        .document(EcommerceApp.sharedPreferences.getString(EcommerceApp.userUID))

        .collection(EcommerceApp.collectionOrders).document(myOrderId).delete();
    ...
    Fluttertoast.showToast(msg: " Order has been Recieved and confirmed ");

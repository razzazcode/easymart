    ...
    AutomaticKeepAliveClientMixin<UploadPage>
{
  ...
  File file;
TextEditingController _descriptioTextEditingController = TextEditingController();
          ...
          return SimpleDialog(
            ...
            children: [
              ...
              SimpleDialogOption(
                ...
                child:   Text(" Choose from gallery" , style: TextStyle (color: Colors.green ),) ,
              ...
              SimpleDialogOption(
                ...
                child:   Text(" capture Photo With Camera " , style: TextStyle (color: Colors.green ),) ,
  ...
  child:Text ( " Add Product " , style: TextStyle (color: Colors.pink ,fontSize: 16.0 , fontWeight: FontWeight.bold),),
      ...
      body: ListView (
        ...
        children: [
          ...
          uploading ? linearProgress() : Text ("Please wait"),
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: TextField (
                ...
                controller: _descriptioTextEditingController,
   ...
   clearFormInfo() {
    ...
    setState(() {
      ...
      _descriptioTextEditingController.clear();
